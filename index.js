...
const theInstructor = new Instructor({
  name: 'Josh',
  age: 32,
  location: 'Florida',
  speciality: 'redux',
...
console.log(theInstructor.demo('math'))
/*
  TASK 5
...
const theNewStudent = new Lambdasian({
name: 'Erik',
age: 25,
location: 'Utah',
...
const theProjMan = new ProjectManager({
  name: 'Jeremy',
  age: 24,
  location: 'San Mateo',
  speciality: 'Project Management',
  favLanguage: 'redux',
  catchPhrase: 'There is always a tomorrow!',
  gradClassName:'CS1',
  favInstructor: 'Sean'
})
